...
struct ProtoItem
{
	...
	const int16  Durability;
    const uint8  Unused[ 94 ];
    // Armor, offset 100
	...
	const int16  Armor_AntiCrit;
    const uint8  Armor_Unused[ 26 ];
    // Weapon, offset 200
    ...
    const uint8  Weapon_CrChance;
    const uint8  Weapon_CrRoll;
    const uint8  Weapon_Unused[ 24 ];
    // Ammo, offset 300
...
struct Item
{
	...
	//Custom values
	int  GetValue0()   const { return (Data.ScriptValues[5]%100); }
	int  GetValue1()   const { return (Data.ScriptValues[5]/ 100) % 100; }
	int  GetValue2()   const { return (Data.ScriptValues[5]/ 10000) % 100; }
	int  GetValue3()   const { return (Data.ScriptValues[5]/ 1000000) % 100; }
	int  GetValue4()   const { return (Data.ScriptValues[5]/ 100000000) % 100; }
	
	int  GetValue5()   const { return (Data.ScriptValues[6]%100); }
	int  GetValue6()   const { return (Data.ScriptValues[6]/ 100) % 100; }
	int  GetValue7()   const { return (Data.ScriptValues[6]/ 10000) % 100; }
	int  GetValue8()   const { return (Data.ScriptValues[6]/ 1000000) % 100; }
	int  GetValue9()   const { return (Data.ScriptValues[6]/ 100000000) % 100; }
	
	int  GetValue10()   const { return (Data.ScriptValues[7]%100); }
	int  GetValue11()   const { return (Data.ScriptValues[7]/ 100) % 100; }
	int  GetValue12()   const { return (Data.ScriptValues[7]/ 10000) % 100; }
	int  GetValue13()   const { return (Data.ScriptValues[7]/ 1000000) % 100; }
	int  GetValue14()   const { return (Data.ScriptValues[7]/ 100000000) % 100; }
	
	int  GetValue15()   const { return (Data.ScriptValues[8]%100); }
	int  GetValue16()   const { return (Data.ScriptValues[8]/ 100) % 100; }
	int  GetValue17()   const { return (Data.ScriptValues[8]/ 10000) % 100; }
	int  GetValue18()   const { return (Data.ScriptValues[8]/ 1000000) % 100; }
	int  GetValue19()   const { return (Data.ScriptValues[8]/ 100000000) % 100; }
	
	int  GetValue20()   const { return (Data.ScriptValues[9]%100); }
	int  GetValue21()   const { return (Data.ScriptValues[9]/ 100) % 100; }
	int  GetValue22()   const { return (Data.ScriptValues[9]/ 10000) % 100; }
	int  GetValue23()   const { return (Data.ScriptValues[9]/ 1000000) % 100; }
	int  GetValue24()   const { return (Data.ScriptValues[9]/ 100000000) % 100; }
};
